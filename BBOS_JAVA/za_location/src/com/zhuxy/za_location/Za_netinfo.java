...
final class za_NetInfo extends MainScreen
{
 ...
 refrethpos l_rpos= new refrethpos();   
  ...
  public String getnetinfo()
  {
       ...
       l_date.setText(String.valueOf(l_c.get(Calendar.YEAR))+"/" 
                      + String.valueOf(l_c.get(Calendar.MONTH)+1)+"/"
                      + String.valueOf(l_c.get(Calendar.DAY_OF_MONTH))+" "
                      + String.valueOf(l_c.get(Calendar.HOUR_OF_DAY))+":"
                      + String.valueOf(l_c.get(Calendar.MINUTE ))+":"        
                      + String.valueOf(l_c.get(Calendar.SECOND)));   
       String l_out="\r\n";                                                   
        try{
  ...
  public void savePos(String str)
  {
       ...
       Calendar l_c = Calendar.getInstance();    
        boolean l_new= false;  
        String fn ="store/home/user/documents/GPRSPos";
        SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd");
        fn += sdf.format(l_c.getTime()) + ".txt";
     try 
     {
