...
class MapFieldDemoSite 
{
     ...
     */
    MapFieldDemoSite(String filePath, String siteName, DemoMapField map) 
    {
        _siteName = siteName;
        _map = map;
        formatSite(filePath);
     ...
     */
    public void formatSite(String filePath) 
    {
                   ...
                   if (MapFieldDemoTokenizer.getString(line).equals("Site Name:")) 
                   {
                        ...
                        if (MapFieldDemoTokenizer.getString(lineReader.readLine()).equals(_siteName)) 
                        {
                            ...
                            if (MapFieldDemoTokenizer.getString(lineReader.readLine()).equals("Default Campus Location:"))
                            {
                                ...
                                campusLocation = MapFieldDemoTokenizer.getCoordinates(lineReader.readLine());
                            }
     ...
     */
    public void drawSite(Graphics g) 
    {
        if (_map != null) 
        {
