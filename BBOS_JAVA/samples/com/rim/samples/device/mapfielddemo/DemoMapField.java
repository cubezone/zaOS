...
class DemoMapField extends MapField 
{
    ...
    // For keypad
    private boolean _reducedKeypad;
    
    /**
     * Initializes map.
     */
    DemoMapField(boolean reducedKeypad) 
    {
        // Sample label is used to determine the relative height of the map and therefore 
        // declared null right after use.
        _sampleLabel = new LabelField();
        _textHeight = _sampleLabel.getPreferredHeight();
        _preferredMapHeight = (int)(Display.getHeight()  - (_sampleLabel.getPreferredHeight() * 3.45));
        _sampleLabel = null;
    ...
    { 
        ...
        {
            if (_latitude != _previousLatitude || _longitude != _previousLongitude) 
            {
     ...
     */
    public void addSite(MapFieldDemoSite site) 
    {
