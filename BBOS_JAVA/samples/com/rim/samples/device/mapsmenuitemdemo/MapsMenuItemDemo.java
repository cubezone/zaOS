...
{    
    ...
    {      
        ...
        _latitudeField = new BasicEditField ("Latitude:      " , _mv.getLatitude()/100000.0 + "" , 9 , BasicEditField.FILTER_REAL_NUMERIC );
        _logitudeField = new BasicEditField ("Longitude:   " , _mv.getLongitude()/100000.0 + "" , 10 , BasicEditField.FILTER_REAL_NUMERIC);
