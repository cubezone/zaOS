...
"CITY","沈阳","481,92","230,300","0.0013",
"SUBWAY","1号线","沈阳","4","180",       
"TIME_FORWORD","25200","360","4","0",
"TIME_BACKWORD","27000","360","4","0",             
"STATION","十三号街站","35,382","2","180",         
"STATION","中央大街站","56,382","6","180",             
"STATION","七号街站","78,382","2","180",                       
"STATION","四号街站","108,382","4","180",                      
"STATION","张士站","134,368","4","180",
"STATION","开发大道站","143,356","4","180",
"STATION","于洪广场站","147,334","2","180",
"STATION","迎宾路站","163,327","6","180",
"STATION","重工街站","189,327","2","180",
"STATION","启工街站","219,328","3","180",
"STATION","保工街站","249,336","3","180",
"STATION","铁西广场站","271,344","6","180",
"STATION","云峰北街站","298,333","2","180",
"STATION","沈阳站站","316,337","6","180",
"STATION","太原街站","338,342","2","180",
"STATION","南市场站","356,342","6","180",
"STATION","青年大街站","374,337","3","180",
"STATION","怀远门站","393,333","5","180",
"STATION","中街站","413,327","5","180",
"STATION","东中街站","434,321","5","180",
"STATION","滂江街站","453,317","2","180",
"STATION","黎明广场站","472,317","6","180",

"SUBWAY","2号线","沈阳","2","180",
"TIME_FORWORD","25200","360","4","0",
"TIME_BACKWORD","27000","360","4","0",
"STATION","松山路站","369,214","8","180",
"STATION","陵西站","359,234","4","180",
"STATION","新乐遗址站","359,252","4","180",
"STATION","北陵公园站","363,269","4","180",
"STATION","崇山路站","372,284","4","180",
"STATION","岐山路站","377,292","4","180",
"STATION","沈阳北站站","389,303","4","180",
"STATION","惠工广场站","382,314","4","180",
"STATION","市府广场站","374,322","4","180",
"STATION","青年大街站","374,337","3","180",
"STATION","青年公园站","374,360","4","180",
"STATION","工业展览馆站","375,382","4","180",
"STATION","文体路站","378,400","4","180",
"STATION","五里河站","391,410","3","180",
"STATION","奥体中心站","431,462","4","180",
"STATION","会展中心站","440,482","4","180",
"STATION","世纪广场站","459,498","4","180",
 ...
 */
 ...
 {
       if (( m_y+ get_y() > -100 )&& (m_y+get_y() < SCREEN_HEIGHT + 100  )
           &&   m_x+get_x() >  -100  && m_x+get_x() < SCREEN_WIDTH + 100  )
        return true; 
      else
        return false;
 }    
...
static class Cstation extends CCell
{
    ...
    {  
        int l_y = 20*m_index;    
        if(( l_y < m_y+SCREEN_HEIGHT) && ( l_y +m_y >0) )
...
{ 
     m_x = (int)((m_x - SCREEN_WIDTH/2 -1)* a/b)+ SCREEN_WIDTH/2 -1;
     m_y = (int)((m_y - SCREEN_HEIGHT/2 -1) * a/b)+SCREEN_HEIGHT/2 -1;    
     m_zoom = m_zoom * a / b;   
}
...
public void changeCity(String cityname)
  {
    ...
    for (int i = 0; i <m_citys.size(); i++)
    {
       ...
       { 
         m_act_city = l_city;
         m_x = SCREEN_WIDTH/2 -1  - l_city.get_x();
         m_y = SCREEN_HEIGHT/2 -1  - l_city.get_y();         
        break;
        }
    }
...
Graphics g_graphics=null;
    ...
    { 
        ...
        m_app = app;
        m_about = new za_about(app);

    }  
    
    protected void paint(Graphics graphics)
    {           
       SCREEN_WIDTH = getScreen().getWidth();
       SCREEN_HEIGHT = getScreen().getHeight();   
       if (m_bitmap == null)
       {
            m_bitmap = new Bitmap(SCREEN_WIDTH,SCREEN_HEIGHT);
 ...
 /*     UiApplication.getUiApplication().invokeLater(new Runnable()
   ...
   */
        if (m_show =="showmap") 
           m_metro.draw(m_graphics,1);           
       if (m_show =="showlist")  
           m_metro.draw(m_graphics,2);    
          
        g_graphics.drawBitmap(0,0,SCREEN_WIDTH,SCREEN_HEIGHT,m_bitmap,0,0);
        String ls_zoom = String.valueOf(m_zoom); 
        Calendar l_c = Calendar.getInstance();
        g_graphics.setFont(m_font_s); 
        g_graphics.setColor(Color.LIGHTCYAN);    
        g_graphics.drawText("Z:"+ls_zoom,1,1);
        g_graphics.drawText(String.valueOf(l_c.get(l_c.YEAR))+"/" 
    ...
    */
    ...
    {
        g_graphics.setBackgroundColor(Color.BLACK);
        g_graphics.clear();
        if (g_graphics !=null)
        g_graphics.drawBitmap(-20 * dx * Math.abs(dx),
                              -20 * dy * Math.abs(dy),
                              SCREEN_WIDTH,SCREEN_HEIGHT,m_bitmap,0,0);    
