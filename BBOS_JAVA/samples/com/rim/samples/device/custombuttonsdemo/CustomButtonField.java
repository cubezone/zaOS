...
class CustomButtonField extends Field implements DrawStyle
{
     ...
     * the shape.
     *
     * @param graphics Graphics context used for drawing the focus.
     ...
     *
     * <p> This field's manager invokes this method during the layout process to
     * instruct this field to arrange its contents, given an amount of available
     * space.
     *
     * @param width Amount of available horizontal space.
     * @param height Amount of available vertical space.
     * */
     ...
     * Redraws this button.
     *
     * <p> This field's manager invokes this method during the repainting
     * process to instruct this field to repaint itself.
     *
     * @param graphics Graphics context for repainting this field.
     * */
