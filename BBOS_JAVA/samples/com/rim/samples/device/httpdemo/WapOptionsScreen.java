...
/** 
 * A simple options screen that allows the user to specify the WAP parameters 
...
public final class WapOptionsScreen extends MainScreen
{
    ...
    // Constructors -------------------------------------------------------------
    public WapOptionsScreen(UiApplication uiapp)
    {
        super();
        _this = this;
        _app = uiapp;
        ...
        setTitle(new LabelField("Wap Options" , LabelField.ELLIPSIS | LabelField.USE_ALL_WIDTH));
    ...
    /**
     * Formats all the fields into the wap parameter string, ready for inclusion in 
