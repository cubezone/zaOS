...
public class GPSDemo extends UiApplication 
{
    ...
    private MenuItem _viewWayPoints = new MenuItem("View Waypoints" , 110, 10) 
    {
        public void run()
        {
    ...
    private final class GPSDemoScreen extends MainScreen
    {
        ...
        {
            RichTextField instructions = new RichTextField("Waiting for location update...");
    ...
    private class OptionScreen extends MainScreen 
    {
        ...
        private MenuItem _cancel = new MenuItem("Cancel",  300000, 10) 
        {
            public void run()
            {
    ...
    {        
        ...
        public ServerConnectThread(String host)
        {
            setHost(host);
            _go = true;
            _data = new Vector();
        ...
        public synchronized void sendUpdate(String data)
        {
