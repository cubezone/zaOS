...
public class AddressBook
{
    ...
    private PersistentObject _persist;          // Refeence to the PersistentObject for our address book.
    private AddressBookRecord[] _records;       // The array of address book records that make up the address book.
