unit ActiveFormWebCamProj1_TLB;
...
// File generated on 2007-5-30 15:06:53 from Type Library described below.

// ************************************************************************  //
// Type Lib: D:\Program Files\Borland\Delphi6\Projects\WebCam\ActiveFormWebCamProj1.tlb (1)
// LIBID: {F8B9ADF2-7AF1-455D-9530-D65F650A15B6}
// LCID: 0
// Helpfile: 
// DepndLst: 
...
const
  ...
  ActiveFormWebCamProj1MajorVersion = 1;
  ActiveFormWebCamProj1MinorVersion = 0;

  LIBID_ActiveFormWebCamProj1: TGUID = '{F8B9ADF2-7AF1-455D-9530-D65F650A15B6}';

  IID_IActiveFormWebCam: TGUID = '{7D7523BF-26AD-4424-B497-238199FBECC6}';
  DIID_IActiveFormWebCamEvents: TGUID = '{78B09CF4-2510-48BE-80CD-713E1FFAD598}';
  CLASS_WebCam: TGUID = '{A17AFE8B-0B33-49F0-B75F-69A9A230142C}';
...
// *********************************************************************//
  IActiveFormWebCam = interface;
  IActiveFormWebCamDisp = dispinterface;
  IActiveFormWebCamEvents = dispinterface;

// *********************************************************************//
// Declaration of CoClasses defined in Type Library                       
// (NOTE: Here we map each CoClass to its Default Interface)              
// *********************************************************************//
  WebCam = IActiveFormWebCam;
...
// *********************************************************************//
// Interface: IActiveFormWebCam
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {7D7523BF-26AD-4424-B497-238199FBECC6}
// *********************************************************************//
  IActiveFormWebCam = interface(IDispatch)
    ['{7D7523BF-26AD-4424-B497-238199FBECC6}']
...
// *********************************************************************//
// DispIntf:  IActiveFormWebCamDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {7D7523BF-26AD-4424-B497-238199FBECC6}
// *********************************************************************//
  IActiveFormWebCamDisp = dispinterface
...
// *********************************************************************//
// DispIntf:  IActiveFormWebCamEvents
// Flags:     (4096) Dispatchable
// GUID:      {78B09CF4-2510-48BE-80CD-713E1FFAD598}
// *********************************************************************//
  IActiveFormWebCamEvents = dispinterface
    ['{78B09CF4-2510-48BE-80CD-713E1FFAD598}']
...
// Control Name     : TWebCam
// Help String      : ActiveFormWebCam Control
// Default Interface: IActiveFormWebCam
// Def. Intf. DISP? : No
// Event   Interface: IActiveFormWebCamEvents
// TypeFlags        : (34) CanCreate Control
// *********************************************************************//
  TWebCamOnKeyPress = procedure(Sender: TObject; var Key: Smallint) of object;

  TWebCam = class(TOleControl)
  private
    ...
    FOnKeyPress: TWebCamOnKeyPress;
    FOnPaint: TNotifyEvent;
    FIntf: IActiveFormWebCam;
    function  GetControlInterface: IActiveFormWebCam;
  protected
    procedure CreateControl;
    procedure InitControlData; override;
  public
    property  ControlInterface: IActiveFormWebCam read GetControlInterface;
    property  DefaultInterface: IActiveFormWebCam read GetControlInterface;
  ...
  published
    ...
    property OnKeyPress: TWebCamOnKeyPress read FOnKeyPress write FOnKeyPress;
...
procedure TWebCam.InitControlData;
const
  ...
  CControlData: TControlData2 = (
    ClassID: '{A17AFE8B-0B33-49F0-B75F-69A9A230142C}';
    EventIID: '{78B09CF4-2510-48BE-80CD-713E1FFAD598}';
    EventCount: 8;
...
procedure TWebCam.CreateControl;

  procedure DoCreate;
  begin
    FIntf := IUnknown(OleObject) as IActiveFormWebCam;
  end;
...
function TWebCam.GetControlInterface: IActiveFormWebCam;
begin
  CreateControl;
  Result := FIntf;
end;
...
procedure Register;
begin
  RegisterComponents('ActiveX',[TWebCam]);
end;
