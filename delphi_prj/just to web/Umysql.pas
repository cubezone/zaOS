...
public
 //       constructor Create(const Msg: string);
	...
	function fetch_field(i :integer) :pchar;
...
begin
   ...
   if mysql_real_connect(m_MySQL, pChar('127.0.0.1'), pChar(User), pChar(Pass), pchar(db), 3306, nil, 0) = nil then Fail;
end;
...
function TpMysql.fetch_field(i :integer) :pchar;
begin
