...
// File generated on 2007-2-18 12:00:17 from Type Library described below.

// ************************************************************************  //
// Type Lib: D:\Program Files\Borland\Delphi6\Projects\act\ActiveFormTTProj1.tlb (1)
// LIBID: {B4466CC1-F0A6-4295-98E1-12D91BBFCD82}
// LCID: 0
// Helpfile: 
// DepndLst: 
...
const
  ...
  ActiveFormTTProj1MajorVersion = 1;
  ActiveFormTTProj1MinorVersion = 0;

  LIBID_ActiveFormTTProj1: TGUID = '{B4466CC1-F0A6-4295-98E1-12D91BBFCD82}';

  IID_IActiveFormTTX: TGUID = '{5234BDD5-86DD-479B-ACFC-4D73EB1FEC2E}';
  DIID_IActiveFormTTXEvents: TGUID = '{9AC6EB26-1F2B-4CE3-A2B2-E87332C911FE}';
  CLASS_ActiveFormTTX: TGUID = '{F4EFA3CE-898F-4478-B1ED-AB437732603F}';
...
// *********************************************************************//
  IActiveFormTTX = interface;
  IActiveFormTTXDisp = dispinterface;
  IActiveFormTTXEvents = dispinterface;

// *********************************************************************//
// Declaration of CoClasses defined in Type Library                       
// (NOTE: Here we map each CoClass to its Default Interface)              
// *********************************************************************//
  ActiveFormTTX = IActiveFormTTX;
...
// *********************************************************************//
// Interface: IActiveFormTTX
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {5234BDD5-86DD-479B-ACFC-4D73EB1FEC2E}
// *********************************************************************//
  IActiveFormTTX = interface(IDispatch)
    ['{5234BDD5-86DD-479B-ACFC-4D73EB1FEC2E}']
...
// *********************************************************************//
// DispIntf:  IActiveFormTTXEvents
// Flags:     (0)
// GUID:      {9AC6EB26-1F2B-4CE3-A2B2-E87332C911FE}
// *********************************************************************//
  IActiveFormTTXEvents = dispinterface
    ['{9AC6EB26-1F2B-4CE3-A2B2-E87332C911FE}']
...
// Control Name     : TActiveFormTTX
// Help String      : ActiveFormTTX Control
// Default Interface: IActiveFormTTX
// Def. Intf. DISP? : No
// Event   Interface: IActiveFormTTXEvents
// TypeFlags        : (34) CanCreate Control
// *********************************************************************//
  TActiveFormTTXOnKeyPress = procedure(Sender: TObject; var Key: Smallint) of object;

  TActiveFormTTX = class(TOleControl)
  private
    ...
    FOnKeyPress: TActiveFormTTXOnKeyPress;
    FOnPaint: TNotifyEvent;
    FIntf: IActiveFormTTX;
    function  GetControlInterface: IActiveFormTTX;
  protected
    procedure CreateControl;
    procedure InitControlData; override;
  public
    property  ControlInterface: IActiveFormTTX read GetControlInterface;
    property  DefaultInterface: IActiveFormTTX read GetControlInterface;
  ...
  published
    ...
    property OnKeyPress: TActiveFormTTXOnKeyPress read FOnKeyPress write FOnKeyPress;
...
procedure TActiveFormTTX.InitControlData;
const
  ...
  CControlData: TControlData2 = (
    ClassID: '{F4EFA3CE-898F-4478-B1ED-AB437732603F}';
    EventIID: '{9AC6EB26-1F2B-4CE3-A2B2-E87332C911FE}';
    EventCount: 8;
...
procedure TActiveFormTTX.CreateControl;

  procedure DoCreate;
  begin
    FIntf := IUnknown(OleObject) as IActiveFormTTX;
  end;
...
function TActiveFormTTX.GetControlInterface: IActiveFormTTX;
begin
  CreateControl;
  Result := FIntf;
end;
...
procedure Register;
begin
  RegisterComponents('ActiveX',[TActiveFormTTX]);
end;
