...
package 
{
	...
	public class zaReadHisCellRender extends UISkin implements ICellRenderer
	{
		...
		public function zaReadHisCellRender()
		{
			super();
			...
			_updatetime.format = _filenameFormat;
		...
		{				
			_beer = data;			
			var o:Record = data as Record;
			_filename.text = o.file;	
			
			
			_icon.setImage("res/bookmark40.png");
			var s:String = o.content.replace("\r\n","");
			s = s.replace("\r","");
			s = s.replace("\n","");
			
			_filenameFormat = _dirflag.format;
			...
			_updatetime.text =  o.updatetime;		
			_updatetime.x = 600 - _updatetime.textWidth - 60;
