...
int zaDirQ10::dirlist()
{
	this->m_0.LoadImg("app/native/res/battery_empty.png",300,300);
	this->m_0.setposition(200,500);
	this->m_1.LoadImg("app/native/res/battery_1.png",300,300);
	this->m_1.setposition(200,500);
	this->m_2.LoadImg("app/native/res/battery_2.png",300,300);
	this->m_2.setposition(200,500);
	this->m_3.LoadImg("app/native/res/battery_3.png",300,300);
	this->m_3.setposition(200,500);
	this->m_4.LoadImg("app/native/res/battery_4.png",300,300);
	this->m_4.setposition(200,500);
	this->m_5.LoadImg("app/native/res/battery_5.png",300,300);
	this->m_5.setposition(200,500);
	this->m_6.LoadImg("app/native/res/battery_6.png",300,300);
	this->m_6.setposition(200,500);
	this->m_7.LoadImg("app/native/res/battery_7.png",300,300);
	this->m_7.setposition(200,500);
	this->m_8.LoadImg("app/native/res/battery_full.png",300,300);
	this->m_8.setposition(200,500);
	this->m_9.LoadImg("app/native/res/battery_power.png",300,300);
	this->m_9.setposition(200,500);
...
//	m_bar3.setposition(384,410);
	...
	m_font.init("/usr/fonts/font_repository/monotype/SlatePro.ttf",15);
	m_fonts.init("/usr/fonts/font_repository/monotype/SlatePro.ttf",9);
	ppopen();

	return 0;
}

int zaDirQ10::dirlist( const char * p)
{
		  struct dirent *ptr;
		  DIR *dir;
		  dir=opendir(p);
...
int zaDirQ10::filedesc(const char * filename,int index)
{
...
void zaDirQ10::porcess(zaWorker * wk)
{
	m_dirty = true;
	if (wk->m_task ==2)
	{
...
//	m_bar3.RunImg();
	...
	bbutil_render_text(m_font.font,info, 140.0f, 560-l_y);
	...
	if (l_timeMin != 0)
		bbutil_render_text(m_fonts.font,info,380.0f, 500-l_y);
...
//		bbutil_render_text(m_fonts.font,info, 60.0f, 140);
	...
	glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
	bbutil_render_text(m_fonts.font, m_nowtime, 150.0f,720-40.0f);
	usleep(2000000);
	return 0 ;
}

void zaDirQ10::disinfo(int l_x,int l_y,int i)
{
...
void zaDirQ10::getbootime()
{

}

char * zaDirQ10::getValue(const char *p)
{
